    ...
    return (
      ...
      <div className="rounded-3xl p-4 bg-purple-950  ">
        ...
        <div className="md:flex  rounded-3xl  h-auto border  shadow-lg  p-4  md:max-w-4xl mx-auto   text-white">
          ...
          {/* 4rd col */}
          <div className=" md:w-48 md:p-4 font-bold  ">
            <div className="  grid grid-rows-3 md:gap-14 gap-2    ">
          ...
          <div className=" md:w-36  p-4  md:text-6xl  ">
            <div className="  flex flex-col md:gap-20 gap-2  ">
              ...
              <div className="p-5 rounded-2xl bg-purple-900/50 items-center flex justify-center  ">
